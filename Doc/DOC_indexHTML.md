...
Contém os elementos com os quais o usuário irá interagir, divididos entre o menu de navegação e a área de conteúdo.

**Cabeçalho e Navegação (`<header>` > `<nav>`)**

* **Identidade da Marca:** O lado esquerdo da barra de navegação exibe o ícone e o título oficial do site.

* **Acesso do Usuário:** Alinhados no mesmo conjunto da *navbar*, encontram-se os botões de ação principal para **LOGIN** e **CADASTRO**.
